...
describe('DateUtils test', function () {
    it('should calculate due date of 2019-10-18T16:02:00 with 10 hours as 2019-10-22T10:02:00.000', function () {
        const due = +DateUtils.calculateDueDate(new Date("2019-10-18T16:02:00"), 10);
        assert.equal(due, +(new Date("2019-10-22T10:02:00.000")));
    });
    it('should calculate due date of 2019-08-11T16:02:00 with 86 hours as 2019-08-27T14:02:00.000', function () {
